...
public class WebSocketClient  implements Runnable {
    ...
    protected   Session UsersSession = null;
    ...
    public void test() {
        ...
        try {
            ...
            UsersSession = container.connectToServer(this, new URI(obj.getLoadBalancerWSURL()));
            UsersSession.getBasicRemote().sendText(message);
            UsersSession.close();
          } catch (Exception e) {
              e.printStackTrace();
          }
